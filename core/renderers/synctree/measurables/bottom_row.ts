...
import type {ConstantProvider} from '../constant.js';
import type {NextConnection} from './../../measurables/next_connection.js';
...
export class BottomRow extends Row {
  ...
  hasRightSquareCorner(_block: BlockSvg): boolean {
    return (
      !!_block.outputConnection &&
      !_block.statementInputCount &&
      !_block.nextConnection
    );
  }
